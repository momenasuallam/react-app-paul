          ...
          <div className="col-md-10">
            <div className="favdetails">
              ...
              <div className="domainnamediv">
                <a href="/name/momina.eth">
                  <h3>momina.eth</h3>
                  <span>&nbsp;</span>
                  <div className="label-container css-11a5vjb e1736otp5">
                    <div className="css-0 e1736otp6">Available</div>
                  </div>
                  <div className="css-70qvj9 e1736otp3">
                    <div className="css-1g360fb epvce7y2">
                      <svg
                        width="25"
                        height="24"
                        className="epvce7y0 css-1topvr1 eyzzej0"
                      >
                        <path
                  ...
                  <div className="css-70qvj9 e1736otp3"></div>
                </a>
              </div>
            </div>
          </div>
